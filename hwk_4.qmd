...
wc_eez <- st_as_sf(wc_eez)
# need to actually plot by individual EEZs to find oyster locations within them
oyster_eez <- st_intersection(wc_eez, oyster_locations_vec)
